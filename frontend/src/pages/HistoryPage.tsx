  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] py-8 text-slate-900 selection:bg-sage-500/20 selection:text-slate-900">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">Service History</h1>
        ...
        {history.length === 0 ? (
          ...
          <div className="space-y-4">
            {history.map((job) => (
              <div 
                key={job.id} 
                className="p-6 rounded-3xl bg-white border border-slate-200 hover:border-slate-300 transition-colors shadow-subtle flex flex-col md:flex-row md:items-center justify-between gap-6"
              >
                <div className="space-y-3 flex-1">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 text-xs text-slate-500 font-mono">
                ...
                <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-2 pt-4 md:pt-0 border-t md:border-t-0 border-slate-100">
